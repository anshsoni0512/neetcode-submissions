...
class Solution:
    def hasCycle(self, head: Optional[ListNode]) -> bool:
        ...
        while f!= None and f.next!=None:  # use 'and' because all the condttions should be satisfied not any one of them 
            ...
            f = f.next.next   # move f 2 steps     None.next gives error thats why we check in while loop condition    # here if f.next== none then none.next gives error thats why f.next!= None
